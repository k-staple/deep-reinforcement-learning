...
class Agent():
	...
	def __init__(self, n_states, n_actions, n_agents, random_seed=3):
		...
		self.local_actor = Actor(n_states, n_actions, 32, 24, 0).to(self.device)
		self.target_actor = Actor(n_states, n_actions, 32, 24, 0).to(self.device)
		self.local_critic = Critic(n_states, n_actions, 32, 24, 0).to(self.device)
		self.target_critic = Critic(n_states, n_actions, 32, 24, 0).to(self.device)	
